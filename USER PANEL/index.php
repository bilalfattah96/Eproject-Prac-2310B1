                  ...
                  <div class="row">
                     ...
                     ?>
                        ...
                        <div class="col-lg-4 col-sm-4">
                           <div class="box_main">
                              <h4 class="shirt_text"><?php echo $row['p_name']; ?></h4>
                              <p class="price_text">Price <span style="color: #262626;">Rs <?php echo $row['p_price']; ?></span></p>
                              <div class="tshirt_img"><img src="../ADMIN DASHBOARD/ProductImages/<?php echo $row['p_img']; ?>"></div>
                              <div class="btn_main">
                                 <div class="buy_bt"><a href="#">Buy Now</a></div>
                                 <div class="seemore_bt"><a href="#"><?php echo $row['c_name']; ?></a></div>
                              </div>
                           </div>
                        </div>
